...
### Pro Tip: Generate Matching Hero Images with AI

One powerful technique for creating cohesive hero sections is using AI image generation to create custom imagery that perfectly matches your design aesthetic. Instead of searching through stock photos or hiring illustrators, you can generate images that seamlessly blend with your color scheme, style, and mood.

For the glassmorphism hero above, we generated a custom illustration of a person working at a computer using Google's Gemini image generation API. The prompt was crafted to match the component's purple, pink, and blue color palette with glassmorphism-style elements.

Here's a bash script that wraps the Gemini API for easy image generation:
...
**Tips for effective AI image prompts:**

1. **Include your color palette** — Mention specific colors like "purple and pink gradient" or "cyan and indigo tones"
2. **Reference the design style** — Terms like "glassmorphism," "neon cyberpunk," or "minimal flat design" help guide the aesthetic
3. **Describe lighting and mood** — "Soft glowing accents," "atmospheric lighting," or "high contrast shadows"
4. **Specify quality markers** — "High quality," "professional," "detailed illustration"
5. **Match the aspect ratio** — Use `-a 4:3` or `-a 16:9` to fit your hero layout

This approach ensures your hero imagery feels custom-made rather than generic stock photography, creating a more cohesive and premium feel for your landing pages.
